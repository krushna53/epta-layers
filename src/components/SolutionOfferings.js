        ...
        <>
            <div className="solution-offering-section">
                <div className="solution-offering-wrapper">
                    <div className="solution-offering-left-section" data-aos="fade-up" data-aos-offset="400">
                    ...
                    <div className="solution-offering-right-section" data-aos="fade-up" data-aos-offset="400">
                        <div className="solution-offring-image">
                            <img src={SolutionOffering_image}/>
                        </div>
                    </div>
                </div>
                <div className="solution-background-image1" data-aos="fade-up" data-aos-offset="400">
                    <img src={SolutionOffering_background1}/>
                </div>
                <div className="solution-background-image2" data-aos="fade-up" data-aos-offset="400">
